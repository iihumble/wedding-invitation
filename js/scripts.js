...
!function (u) {
    ...
    (Neela = {
        ...
        build: function () {
            var e = this;
            e.neelaStyle(), e.preloader(), e.navigation(), e.createMobileMenu(), e.heroHeight(), u("input, textarea").placeholder(), e.googleMap(), e.createLightboxGallery(), e.createBackgroundSlideshow(), e.createOwlSliders(), e.createGallery(), e.bgImageGrid(), e.countdown(), e.parallaxBg()
        },
        events: function () {
            var e, t, a = this;
        ...
        navigation: function () {
            u(".nav li a").on("click", function (e) {
                ...
                "#" === t.attr("href").charAt(0) && u(t.attr("href")).length ? (e.preventDefault(), "#hero" !== t.attr("href") && null !== u(t.attr("href")).offset() && (a = u(t.attr("href")).offset().top - 55), u("html, body").stop().animate({scrollTop: a}, 1500, "easeOutExpo", function () {
                    t.blur()
                ...
                "" !== e && (location.hash = "", u("html, body").stop().animate({scrollTop: u("#" + e).offset().top - 65}, 1500, "easeInOutExpo")), void 0 !== window.Waypoint && new Waypoint.Sticky({element: u(".nav-section")})
            })
        },
        createMobileMenu: function (e) {
            var n, t = this, o = u("#wrapper"), i = u.browser.mobile ? "touchstart" : "click";
            null !== e && (e = u(window).innerWidth()), e <= 975 && !t.mobMenuFlag && (u("body").prepend('<nav class="nav-mobile"><i class="fa fa-times"></i><h2>' + t.mobileMenuTitle + "</h2><ul></ul></nav>"), u(".nav-mobile > ul").html(u(".nav").html()), u(".nav-mobile b, .nav-mobile .nav-logo").remove(), u(".nav-mobile ul.dropdown-menu").removeClass().addClass("dropdown-mobile"), u(".navbar > a.btn").length && (u(".navbar > a.btn").each(function () {
                ...
                var t = u(this), a = 0;
                "#hero" !== t.attr("href") && (a = u(t.attr("href")).offset().top - 65), u("html, body").stop().animate({scrollTop: a}, 1500, "easeInOutExpo", function () {
                    t.blur()
                }), o.removeClass("open"), n.removeClass("open"), u(document).off(i), e.preventDefault()
            }))
        },
        heroHeight: function () {
            this.heroFullScreen && (u("#hero").css({minHeight: u(window).innerHeight() + "px"}), u(window).resize(function () {
                var e = parseInt(u("#hero").css("padding-bottom")) + 70,
                    t = parseInt(u("#hero").next("section").css("margin-top")), a = u(window).innerHeight() - e,
                    n = u("#hero >.container").height(), o = -10;
                t < 0 && !Number.isNaN(t) && (a += t + e), n = a - n, u(".nav-section.light").length && (o = 10), 0 < n && u(".v-center").length && u("#hero >.container").css({"margin-top": n / 2 + o + "px"}), u("#hero").css({minHeight: u(window).innerHeight() + "px"})
            }))
        },
        ...
        googleMap: function () {
            var e, t, a, s, n, o, i, r, l = this, c = [], d = 0;
            if (0 === u(".gmap").length || "undefined" === l.mapMarkers || 0 === l.mapMarkers.length || void 0 === window.google) return !1;
            /^\d|\.|-$/.test(l.mapInitialLatitude) && /^\d|\.|-$/.test(l.mapInitialLongitude) || (l.mapInitialLatitude = l.mapMarkers[0].latitude, l.mapInitialLongitude = l.mapMarkers[0].longitude), t = new google.maps.LatLng(l.mapInitialLatitude, l.mapInitialLongitude), l.useDefaultMapStyle || (c = [{stylers: [{hue: l.mapColor}, {saturation: -75}, {lightness: 5}]}, {
                ...
                featureType: "road",
                elementType: "geometry",
                stylers: [{hue: l.mapColor}, {saturation: -100}, {lightness: 0}]
            }, {
                featureType: "road.highway",
                elementType: "geometry",
                stylers: [{hue: l.mapColor}, {saturation: 5}, {lightness: 5}]
            }, {
                featureType: "road",
                ...
                featureType: "transit",
                elementType: "geometry",
                stylers: [{hue: l.mapColor}, {saturation: 30}, {lightness: -30}]
            }]), e = new google.maps.StyledMapType(c, {name: "Neela"}), i = google.maps.ControlPosition.RIGHT_CENTER, r = google.maps.ControlPosition.RIGHT_BOTTOM, c = google.maps.ControlPosition.RIGHT_TOP, l.rtlFlag && (i = google.maps.ControlPosition.LEFT_CENTER, r = google.maps.ControlPosition.LEFT_BOTTOM, c = google.maps.ControlPosition.LEFT_TOP), a = {
                center: t,
                ...
                for (n = u(this).attr("id"), (s = new google.maps.Map(document.getElementById(n), a)).mapTypes.set("map_style", e), s.setMapTypeId("map_style"), o = function (e) {
                    var t = e.latitude, a = e.longitude, n = e.icon, e = e.infoWindow,
        ...
        createGallery: function () {
            var e = u(".gallery-scroller"), t = !1;
            u(".gallery-scroller").length && (u(".gallery-right").on("click", function () {
                return !t && (t = !0, void e.animate({scrollLeft: e.scrollLeft() + 380}, function () {
                    t = !1
                }))
        ...
        countdown: function () {
            ...
            u(".countdown").length && (o = function (e, t, a) {
                ...
                var e, t, a = u(this), n = new Date(a.data("date"));
        ...
        parallaxBg: function () {
            ...
            !u.browser.mobile && 992 < u(window).innerWidth() ? u(window).on("scroll", function () {
                ...
                u(".parallax-background").each(function () {
                    var e = u(this), t = e.offset().top, a = e.outerHeight();
        ...
        contactForm: function () {
            ...
            u(".submit_form").on("click", function (e) {
                var t, a, n, o = u(this), i = o.closest("form"), s = u("input, textarea, select, fieldset", i), r = 0,
                    l = /\S+@\S+\.\S+/, c = "contact", d = !1;
        ...
        objEvents: function () {
            u(".btn").each(function () {
                var e = u(this), t = e.width(), a = 2, n = e.text().split(" ").length;
                ...
                var t = u(this), a = 0, n = t.attr("href");
                /#/.test(n) && u(n).length && (e.preventDefault(), "#hero" !== n && (a = u(n).offset().top - 65), u("html, body").stop().animate({scrollTop: a}, 1500, "easeInOutExpo", function () {
                    t.blur()
                }))
        ...
        parallaxTimeline: function () {
            ...
            this.timelineParallax && (i = function (n) {
                u("> div", this).each(function () {
                    var e = u(this), t = e.attr("data-parallax"), a = n.clientX * t / 300, t = n.clientY * t / 300;
                    e.css({
                ...
                var n = u(window).scrollTop(), o = u(window).height();
                u('.timeline [class^="template-"]').each(function () {
                    var e = u(this), t = e.offset().top, a = e.height();
        ...
        animateElems: function () {
            function e() {
                u("[data-animation-delay]").each(function () {
                    var e = u(this), t = u(window).scrollTop(), a = u(window).height(),
                        n = parseInt(e.attr("data-animation-delay"), 10), o = e.data("animation-direction");
